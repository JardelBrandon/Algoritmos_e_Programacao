...
if comb == "G" :
    ...
    consumo = ( ( ( GASOLINA * propG )* litros ) + ( ( ETANOL * (1 - propG ) )* litros ) ) /  litros
    if consumo * litros  >= dist :
